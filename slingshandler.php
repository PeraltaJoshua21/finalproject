...
<form>
  <h2 style="text-align: center;"> LIST OF SLINGS </h2>
  <hr />
...
<?php
        include("connect.php");
        $view_users="SELECT * from product WHERE prod_type='Slings'";
        ...
        <tr>
            ...
            <td><a class="btn btn-danger" href="deleteslings_handler.php?del=<?php echo $prod_id ?>">Delete Product</a></td> 
        </tr>
      <?php } ?> 
    </table>
        </div>
