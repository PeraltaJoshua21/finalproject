 ...
 {  
      ...
      {  
           ...
           {  
                ...
                echo '<script>window.location="slings.php"</script>';  
           }  
      }  
      else  
      {  
      ...
      {  
           ...
           {  
                ...
                {  
                     ...
                     echo '<script>window.location="orderdetailsslings.php"</script>';  
                }  
           }  
      }  
 }  
...
<br><br><br><br>
  <a class="btn btn-primary" href="orderdetailsslings.php"> View Cart </a>
 <div class="container" style="width:1000px;">  
                <h3 align="center">USC Slings</h3><br />  
                <?php  
                $query = "SELECT * FROM product WHERE prod_type = 'Slings'";  
                ...
                ?>  
                <div class="col-md-4">  
                     <form method="post" action="slings.php?action=add&id=<?php echo $row["prod_id"]; ?>">  
