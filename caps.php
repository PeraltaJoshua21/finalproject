 ...
 {  
      ...
      {  
           ...
           {  
                ...
                echo '<script>window.location="caps.php"</script>';  
           }  
      }  
      else  
      {  
      ...
      {  
           ...
           {  
                ...
                {  
                     ...
                     echo '<script>window.location="orderdetailscaps.php"</script>';  
                }  
           }  
      }  
 }  
...
<br><br><br><br>
  <a class="btn btn-primary" href="orderdetailscaps.php"> View Cart </a>
 <div class="container" style="width:1000px;">  
                <h3 align="center">USC Caps</h3><br />  
                <?php  
                $query = "SELECT * FROM product WHERE prod_type='Caps'";  
                ...
                ?>  
                <div class="col-md-4">  
                     <form method="post" action="caps.php?action=add&id=<?php echo $row["prod_id"]; ?>">  
                          <div style="border:1px solid #5cb85c; background-color:#f1f1f1; border-radius:5px; padding:16px;" align="center">  
                               <img src="<?php echo $row["p\image"]; ?>" class="img-responsive" /><br />  
