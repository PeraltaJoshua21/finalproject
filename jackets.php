 ...
 {  
      ...
      {  
           ...
           {  
                ...
                echo '<script>window.location="jackets.php"</script>';  
           }  
      }  
      else  
      {  
      ...
      {  
           ...
           {  
                ...
                {  
                     ...
                     echo '<script>window.location="orderdetailsjackets.php"</script>';  
                }  
           }  
      }  
 }  
...
<br><br><br><br>
  <a class="btn btn-primary" href="orderdetailsjackets.php"> View Cart </a>
 <div class="container" style="width:1000px;">  
                <h3 align="center">USC Jackets</h3><br />  
                <?php  
                $query = "SELECT * FROM product WHERE prod_type='Jackets'";  
                ...
                ?>  
                <div class="col-md-4">  
                     <form method="post" action="jackets.php?action=add&id=<?php echo $row["prod_id"]; ?>">  
