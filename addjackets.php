        ...
        <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
            <div class="panel panel-info" >
                    ...
                    <div style="padding-top:30px" class="panel-body" >
                        ...
                        <form class="form-horizontal" action="addjacket_handler.php" method="POST"  enctype="multipart/form-data">
                            ...
                            <div style="margin-bottom: 25px" class="input-group">
                                    ...
                                    <div class="col-md-6 col-md-offset-3 controls">
                                       <button type="submit" value="addProdButton" class="btn btn-success form-control" style="width: 200px;">Add a Product</button>
